...
param hostPoolUseCase string = toLower('nbbexternal')
...
param ouPath string = 'OU=Pooled-External,OU=AzureVirtualDesktops,OU=New Belgium Workstations,DC=newbelgium,DC=com'
param domainJoinOptions int = 3

// Virtual Machine Details

param AVDnumberOfInstances int = 2
param virtualMachinePrefix string = 'nbbavdext'
@allowed([
  'Premiumv2_LRS'
  'UltraSSD_LRS'
  'Premium_ZRS'
...
param virtualMachineDiskType string = 'Premiumv2_LRS'
...
param resourceGroupName string = '${CAFPrefix}avdrg02'
