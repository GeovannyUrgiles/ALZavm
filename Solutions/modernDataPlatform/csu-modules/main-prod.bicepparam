...
param productionSKUs = true
param bypassVirtualNetwork = false
param bypassRoles = false
param bypassFunctionApp = false
param bypassWebApp = false
param bypassDatalake = false
param bypassAzureSQL = false
param bypassAutomation = false
param bypassKeyVault = false
param bypassLogAnalytics = false
param bypassUAMI = false

param location = 'westus2'
var locationShort = 'wus2'

param subscriptionId = '54b2b574-2395-44d9-a160-2472fbe3be04'
...
param spokeAddressSpace = '10.152.60.0/23'
param endpointSubnetName = 'privateEndpointSN01'
param endpointSubnetCIDR = '10.152.60.0/24'
param functionAppSubnetName = 'functionAppSN01'
param functionAppSubnetCIDR = '10.152.61.0/26'
param dnsServers = [
  '10.152.41.68'
]
param nsgRules = []
